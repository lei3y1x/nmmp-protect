...
public class Prefs {
    ...
    public static String ndkName(){
        return config().abiconfig.so_name;
    }
    public static String ndkClassN(){
        return config().abiconfig.so_init_calss;
    }
    public static String ndkMethodM(){
        return config().abiconfig.so_init_method;
    }
    public static String ndkMethodType(){
        return config().abiconfig.methodType;
    }
    public static String AARMethod(){
